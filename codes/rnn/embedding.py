...
class embed(nn.Module):
    def __init__(self, char_vocab_size, word_vocab_size, embed_type=None, wti=None):
        super().__init__()
        ...
        if embed_type == 'glove':
            embedding = nn.Embedding(len(wti), 300, padding_idx=PAD_IDX)
            embedding = load_pretrain(300, wti, type=embed_type)
