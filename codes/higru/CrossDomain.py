...
def main():
	...
	parser.add_argument('-save_dir', type=str, default="../../data/higru_bert_data/models_shorit",	# Save the model and results in snapshot/
	...
	parser.add_argument('-d_fc', type=int, default=100,		# FC size 100
						help='the size of fc')
	parser.add_argument('-gpu', type=str, default="cpu",		# Spcify the GPU for training
						help='gpu: default 0')
